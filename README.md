...
| Source | Description | Last Updated | Hedge Fund Quality (:heavy_check_mark: = yes, :test_tube: for research dataset, :x: = no) | Research Paper | Research Code |
| ------------ | ------------ | ------------ | ------------ | ------------ | ------------ |
