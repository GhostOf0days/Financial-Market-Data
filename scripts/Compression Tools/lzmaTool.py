...
def compress(input_file, output_file):
    ...
    with open(input_path, 'rb') as f_in:
        with lzma.open(output_path, 'wb', preset=9 | lzma.PRESET_EXTREME) as f_out:
...
# Example values:
# input_file = '../../datasets/$AAPL Option Chains Dataset/aapl_2016_2020.csv' or '../datasets/$AAPL Option Chains Dataset/aapl_2016_2020.csv.lzma'
# compressed_file = '../../datasets/$AAPL Option Chains Dataset/aapl_2016_2020.csv.lzma'
...
compressed_file = '../../datasets/folder/file_name.file_extension.lzma'
